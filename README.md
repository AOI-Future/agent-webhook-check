...
- **The verification kit** — every check plus the timestamped evidence artifact. **Available now** — <https://0xshugo.gumroad.com/l/AI-Agent?utm_source=github&utm_medium=tool&utm_campaign=agent_security_funnel&utm_content=readme>.
